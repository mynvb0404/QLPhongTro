...
CREATE TABLE HOADON (
	...
	TIENTHUENHA DECIMAL(18,2) NOT NULL DEFAULT 0
        CHECK (TIENTHUENHA >= 0),


    TONGTIEN AS (TIENNUOC + TIENDIEN + TIENPHATSINH + TIENTHUENHA),
...
/*  ======== HOADON ======= */
INSERT INTO HOADON (MAHOPDONG, NGAYLAP, TIENNUOC, TIENDIEN, TIENPHATSINH, TIENTHUENHA, TRANGTHAITT, NGAYTHANHTOAN, PHUONGTHUCTT) VALUES 
('HD001', '2026-03-01', 120000.00, 380000.00, 50000.00, 5000000.00, N'Đã thanh toán', '2026-03-04', N'Chuyển khoản'),
('HD002', '2026-03-05', 90000.00,  280000.00, 0.00, 5000000.00, N'Đã thanh toán', '2026-03-05', N'Tiền mặt');

INSERT INTO HOADON (MAHOPDONG, NGAYLAP, TIENNUOC, TIENDIEN, TIENPHATSINH, TIENTHUENHA, TRANGTHAITT, NGAYTHANHTOAN, PHUONGTHUCTT) VALUES 
('HD001', '2026-04-01', 130000.00, 410000.00, 0.00, 5000000.00, N'Đã thanh toán', '2026-04-05', N'Quét mã QR'),
('HD002', '2026-04-05', 95000.00,  310000.00, 0.00, 5500000.00, N'Đã thanh toán', '2026-04-06', N'Chuyển khoản'),
('HD003', '2026-04-05', 150000.00, 520000.00, 100000.00, 7000000.00, N'Đã thanh toán', '2026-04-07', N'Chuyển khoản'),
('HD004', '2026-04-15', 180000.00, 490000.00, 0.00, 7500000.00, N'Đã thanh toán', '2026-04-17', N'Quét mã QR');

INSERT INTO HOADON (MAHOPDONG, NGAYLAP, TIENNUOC, TIENDIEN, TIENPHATSINH, TIENTHUENHA, TRANGTHAITT, NGAYTHANHTOAN, PHUONGTHUCTT) VALUES 
('HD001', '2026-05-01', 150000.00, 450000.00, 0.00, 6000000.00, N'Đã thanh toán','2026-05-05', N'Chuyển khoản'),
('HD002', '2026-05-05', 100000.00, 300000.00, 0.00, 4000000.00,N'Đã thanh toán','2026-05-09', N'Tiền mặt'),
('HD003', '2026-05-05', 160000.00, 580000.00, 0.00, 7000000.00, N'Đã thanh toán', '2026-05-08', N'Chuyển khoản'),
('HD004', '2026-05-15', 190000.00, 510000.00, 30000.00,  7500000.00, N'Chưa thanh toán', NULL, NULL),
('HD005', '2026-05-15', 80000.00,  220000.00, 0.00, 6500000.00, N'Chưa thanh toán', NULL, NULL);
GO
